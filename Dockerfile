...
RUN yum install -y -q python-pip maven java-1.8.0-openjdk-devel fontconfig dejavu-sans-fonts git parallel which npm net-tools; yum clean all; pip install awscli gitlabform

# Install jenkins
ENV JENKINS_VERSION 2.84

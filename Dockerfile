...
RUN yum install -y -q python-pip java-1.8.0-openjdk-devel fontconfig dejavu-sans-fonts git parallel which npm net-tools; yum clean all; pip install awscli
